...
As can be found above, random forest model shows high accuracy 0.9986 compare with simple decision tree 0.73 when trained/cross-validated on the subsets of train datasets. Thus, we will use RF model fitting to predict the 20 real test cases. Please find below the printed results.
